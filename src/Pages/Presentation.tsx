...
export const Presentation = () => {
  ...
  // Array de fotos
  const photos = ["/foto2.png", "/foto3.png"];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Logo Background */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center h-screen relative z-10">
          {/* Left side - Content */}
          <div className="order-2 lg:order-1 space-y-2 lg:space-y-2 py-8 lg:py-0">
            {/* Name */}
            <div>
          ...
          {/* Right side - Carrusel de fotos */}
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative">
              {/* Profile Image with fade transition */}
              <div className="relative w-[260px] h-[320px] sm:w-[320px] sm:h-[400px] md:w-[360px] md:h-[450px] lg:w-[400px] lg:h-[500px] xl:w-[440px] xl:h-[550px] overflow-hidden">
                <img
